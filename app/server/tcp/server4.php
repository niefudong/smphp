...
$server->on('Receive', function ($server, $fd, $reactor_id, $data) {
    ...
    //                    $device = select_device_by_token($client_data['token']);
//
//                    if($device->heart==0){
//
//                        $response_data = [
...
//                        ];
//
//                        $filter = ['token'=>$client_data['token']];
//
//                        mongodb_update('device','dev_sn',$filter,['heart'=>1]);
//
//                    }else if($device->heart==1){
//
//                        $response_data = [
//                            'command' => "SET_LASER",
//                            'version' => "1.0",
...
//                        $filter = ['token'=>$client_data['token']];
//
//                        mongodb_update('device','dev_sn',$filter,['heart'=>0]);
//                    }
});
